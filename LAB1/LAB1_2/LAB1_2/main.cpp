...
// Задание а.
// Простые числа возводятся в квадрат
...
int main()
{
	...
	// Контейнер из 10 случайных чисел
	...
	std::cout << std::endl;
	std::cout << "Нечётные по возрастанию, "
		"затем чётные по убыванию:"
		<< std::endl;
	...
	// Если пользователь ввёл границы наоборот,
	// меняем их местами
	...
	std::vector<int> rangeNumbers =
		uniqueInRange(numbers, minValue, maxValue);
